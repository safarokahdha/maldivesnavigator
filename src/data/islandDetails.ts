...
export const islandDetails: Record<string, IslandDetail> = {
  ...
  maafushi: {
    ...
    howToGetHere: [
      ...
      { step: 3, text: "Or board the public MTCC ferry route 309 from Malé (Villingili Ferry Terminal, ~$2, ~90 min). Check current MTCC timetable before travel — schedules vary by direction." },
  ...
  thulusdhoo: {
    ...
    howToGetHere: [
      { step: 1, text: "Land at Velana International (MLE)." },
      { step: 2, text: "Speedboat from Malé (~$30, 30–45 min depending on operator) — most surf camps include transfer in the package." },
      { step: 3, text: "Or public MTCC ferry route 308 from Malé (~$2, ~1 hour). Check current MTCC timetable — schedules vary." },
    ],
    relatedJournalSlugs: [],
  },
  ...
  dhigurah: {
    ...
    howToGetHere: [
      ...
      { step: 4, text: "Or public MTCC ferry (multi-leg South Ari route, ~4 hours, ~$5). Check current MTCC timetable before travel — schedules change." },
    ],
    relatedJournalSlugs: [],
  },
  ...
  rasdhoo: {
    ...
    howToGetHere: [
      ...
      { step: 3, text: "Or public MTCC ferry route 301 (Rasdhoo–Ukulhas–Mathiveri–Feridhoo–Maalhos–Himandhoo, ~$5, ~3.5 hours from Malé). Check current MTCC timetable before travel." },
    ],
    relatedJournalSlugs: [],
  },
  ...
  fulidhoo: {
    ...
    essentials: {
      population: 400,
      transferFromMale: "~3h 20min by MTCC route 306 ferry, 1 hour by speedboat",
      transferType: "mixed",
      transferCost: 40,
      ferryDays: [],
    ...
    howToGetHere: [
      ...
      { step: 3, text: "Or public MTCC ferry route 306 (Malé → Maafushi → Fulidhoo, ~3h 20min total). Check current MTCC timetable before travel — schedules change." },
    ],
    relatedJournalSlugs: [],
  },
  ...
  gulhi: {
    ...
    howToGetHere: [
      ...
      { step: 3, text: "Or public MTCC ferry route 309 from Malé (~$2, ~70 min — same route as Maafushi). Check current MTCC timetable before travel." },
    ],
    relatedJournalSlugs: [],
  },
